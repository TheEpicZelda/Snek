    ...
    case WM_PAINT:
        {
            ...
            {
                int c = rand() % 255 + 1;
                SetDCBrushColor(hdc, RGB(0, c, 0));
                //Rectangle(hdc, playsnake.getSegment(i).getX() * 10 + xOffset, playsnake.getSegment(i).getY() * 10 + yOffset, (playsnake.getSegment(i).getX() + 1) * 10 + xOffset, (playsnake.getSegment(i).getY() + 1) * 10 + yOffset);
                drawSnakeBodySegment(hdc, playsnake.getSegment(i), playsnake.getSegment(i - 1), playsnake.getSegment(i + 1), xOffset, yOffset);
            }
            //drawSnakeBodySegment(hdc, playsnake.getTail(), playsnake.getSecondLast(), playsnake.getTail(), xOffset, yOffset);
